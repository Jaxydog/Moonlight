...
public class MLItems {
	...
	public static final MLItem AMONGUS = new MLItem(
		...
		new Config("amongus")
			.withTooltip()
			.lootModifier(new LootModifier().chance(0.225f).rolls(1).table(LootTables.SIMPLE_DUNGEON_CHEST))
	);

	public static final MLItem AVOCADO = new MLItem(
		new Settings()
			.food(new FoodComponent.Builder().hunger(3).saturationModifier(1.125f).build())
			.rarity(Rarity.UNCOMMON),
		new Config("avocado")
			.lootModifier(new LootModifier().chance(0.0125f).rolls(1).table(Blocks.JUNGLE_LEAVES.getLootTableId()))
			.useSound(MLSoundEvents.ITEM_AVOCADO_JINGLE)
			.withTooltip()
	);

	public static final MLItem BANANA = new MLItem(
		new Settings()
			.food(new FoodComponent.Builder().hunger(2).saturationModifier(1f).snack().build())
			.rarity(Rarity.UNCOMMON),
		new Config("banana")
			.lootModifier(new LootModifier().chance(0.0125f).rolls(3).table(Blocks.JUNGLE_LEAVES.getLootTableId()))
			.withTooltip()
	);
	...
	public static final MLItem BIRCH_NUT = new MLItem(
		...
		new Config("birch_nut")
			.lootModifier(new LootModifier().chance(0.015f).rolls(2).table(Blocks.BIRCH_LEAVES.getLootTableId()))
			.withTooltip()
	);
	...
	public static final BouquetItem BOUQUET = new BouquetItem(
		new Settings()
			.food(new FoodComponent.Builder().alwaysEdible().hunger(0).saturationModifier(0).build())
			.maxCount(16)
			.rarity(Rarity.EPIC),
	...
	public static final ButterMilkItem BUTTERMILK = new ButterMilkItem(
		new Settings()
			.food(new FoodComponent.Builder().alwaysEdible().hunger(6).saturationModifier(0.25f).build())
			.maxCount(1)
			.rarity(Rarity.EPIC)
	...
	public static final CaramelAppleItem CARAMEL_APPLE = new CaramelAppleItem(
		new Settings()
			.food(new FoodComponent.Builder().hunger(5).saturationModifier(0.45f).snack().build())
			.rarity(Rarity.UNCOMMON),
	...
	public static final MLItem CARAMEL_BOTTLE = new MLItem(
		new Settings()
			.food(new FoodComponent.Builder().hunger(1).saturationModifier(0.25f).snack().build())
			.maxCount(16)
			.rarity(Rarity.COMMON)
	...
	public static final MLItem CHEESE_STEAK = new MLItem(
		new Settings()
			.food(new FoodComponent.Builder().hunger(10).meat().saturationModifier(0.625f).build())
			.rarity(Rarity.UNCOMMON),
	...
	public static final MLItem CHEESY_BIRCH_NUT = new MLItem(
		new Settings()
			.food(new FoodComponent.Builder().hunger(3).saturationModifier(1.125f).snack().build())
			.rarity(Rarity.UNCOMMON),
		new Config("cheesy_birch_nut").withTooltip()
	);

	public static final MLItem CHEESY_DINO_NUGGIE = new MLItem(
		new Settings()
			.food(new FoodComponent.Builder().hunger(8).meat().saturationModifier(0.925f).snack().build())
			.rarity(Rarity.UNCOMMON),
	...
	public static final MLItem CHEESY_DINO_VEGGIE = new MLItem(
		new Settings()
			.food(new FoodComponent.Builder().hunger(7).saturationModifier(0.925f).snack().build())
			.rarity(Rarity.UNCOMMON),
	...
	public static final MLItem CHEESY_GOOBY_NUGGIE = new MLItem(
		new Settings()
			.food(new FoodComponent.Builder().hunger(9).meat().saturationModifier(0.925f).snack().build())
			.rarity(Rarity.UNCOMMON),
	...
	public static final MLItem CHEESY_GOOBY_VEGGIE = new MLItem(
		new Settings()
			.food(new FoodComponent.Builder().hunger(8).saturationModifier(0.925f).snack().build())
			.rarity(Rarity.UNCOMMON),
		new Config("cheesy_gooby_veggie").withTooltip()
	);

	public static final MLItem CHEESY_MASHED_POTATOES = new MLItem(
		new Settings()
			.food(new FoodComponent.Builder().hunger(4).saturationModifier(0.875f).build())
			.rarity(Rarity.UNCOMMON),
		new Config("cheesy_mashed_potatoes").withTooltip()
	);
	...
	public static final MLItem DINO_VEGGIE = new MLItem(
		new Settings()
			.food(new FoodComponent.Builder().hunger(6).saturationModifier(0.65f).snack().build())
			.rarity(Rarity.UNCOMMON),
	...
	public static final MLItem GOOBY_NUGGIE = new MLItem(
		new Settings()
			.food(new FoodComponent.Builder().hunger(8).meat().saturationModifier(0.65f).snack().build())
			.rarity(Rarity.UNCOMMON),
	...
	public static final MLItem GOOBY_VEGGIE = new MLItem(
		new Settings()
			.food(new FoodComponent.Builder().hunger(7).saturationModifier(0.65f).snack().build())
			.rarity(Rarity.UNCOMMON),
	...
	public static final MLItem MACARONI_AND_CHEESE = new MLItem(
		new Settings()
			.food(new FoodComponent.Builder().hunger(5).saturationModifier(1.125f).build())
			.rarity(Rarity.UNCOMMON),
	...
	public static final MilkBottleItem MILK_BOTTLE = new MilkBottleItem(
		new Settings()
			.food(new FoodComponent.Builder().alwaysEdible().hunger(2).saturationModifier(1.5f).build())
			.maxCount(16)
			.rarity(Rarity.EPIC),
